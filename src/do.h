...
// Dynamically get water temperature from temp sensor
#define READ_TEMP 25

// Single point calibration needs to be filled CAL1_V and CAL1_T
#define CAL1_V (1869)  // mv
#define CAL1_T (25)    // ℃
...
void readDOSensor() {
  ...
  // Read DO sensor values
  ADC_Raw = analogRead(DO_PIN);
  ADC_Voltage = uint32_t(VREF) * ADC_Raw / ADC_RES;
  doValue = readDO(ADC_Voltage, Temperaturet) / 1000.0;  // Convert to mg/L
  // Print the results
